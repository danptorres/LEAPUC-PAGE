    ...
    <div className='home'>
        ...
        <div className="teco23-container">
          ...
          <div className="teco23-text">
            <p>
              É claro que a Raposa não ficaria de fora do TECO 23, o tradicional Torneio das Engenharias do Centro-Oeste. Nossos atletas entregaram tudo em quadra e com a caneca na mão é claro, sempre representando a maior da região. 
            </p>
          </div>
        </div>
    </div>
